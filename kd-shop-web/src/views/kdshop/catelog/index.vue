    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['kdshop:catelog:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['kdshop:catelog:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['kdshop:catelog:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listCatelog, getCatelog, delCatelog, addCatelog, updateCatelog, exportCatelog } from "@/api/kdshop/catelog";
  ...
  methods: {
    ...
    getList() {
      ...
      listCatelog(this.queryParams).then(response => {
        this.catelogList = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateCatelog(this.form).then(response => {
              this.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addCatelog(this.form).then(response => {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有闲置分类数据项?', "警告", {
          ...
          return exportCatelog(queryParams);
        }).then(response => {

    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['kdshop:image:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['kdshop:image:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listImage, getImage, delImage, addImage, updateImage, exportImage } from "@/api/kdshop/image";

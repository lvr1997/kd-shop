        ...
        <div class="row">
          <div class="col-xl-8 col-lg-8">
                ...
                <div class="shop-tab f-right">
                  <ul class="nav text-center">
                    <li class="nav-item">
                      <a
                        class="nav-link"
                        :class="showGoodsOrOrders ? 'active' : ''"
                        title="我发布的闲置"
                        @click="showGoodsOrOrders = !showGoodsOrOrders"
                        ><ShopOutlined
                      /></a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="tab-content">
              <div class="tab-pane fade show active">
                <!-- 我发布的商品-->
                <div class="tab-pane-mygoods" v-if="showGoodsOrOrders">
                  <GoodInfo></GoodInfo>
                  <GoodInfo></GoodInfo>
                  <GoodInfo></GoodInfo>
                  <GoodInfo></GoodInfo>
          ...
          <div class="col-xl-4 col-lg-4">
            <div class="sidebar-box">
              <div class="shop-widget user-header">
                <img
                  class="user-avator"
                  src="@/static/picture/author.png"
                  alt=""
                />
              </div>

              <div class="shop-widget">
                <h3 class="shop-title">我的钱包</h3>
                <div class="shop-wallet">
                  <span>0.00</span>
                  <button class="btn btn-primary btn-wallet-earn">充值</button>
                </div>
              </div>

              <div class="shop-widget">
                <h3 class="shop-title">收支情况</h3>
                <div class="price-filter"></div>
              </div>

              <!-- 我发布过的分类 -->
              <div class="shop-widget">
                <h3 class="shop-title">我发布的分类</h3>
                <ul class="shop-tag">
              ...
              <!-- 我收到的留言 -->
              <div class="shop-widget">
                <h3 class="shop-title">我收到的留言</h3>
                <ul class="shop-sidebar-product">
                  <li>
                    <div class="side-pro-img">
                      <a href="product-details.html"
                        ><img src="@/static/picture/shop-rsp1.jpg" alt=""
                      /></a>
                    </div>
                    <div class="side-pro-content">
                      <h5><a href="product-details.html">用户A</a></h5>
